...
let iconButton1 = document.getElementById("icon-button1");
let iconButton2 = document.getElementById("icon-button2");
let iconButton3 = document.getElementById("icon-button3");
let iconButton4 = document.getElementById("icon-button4");
...
iconButton1.addEventListener("click", function(){
    iconButton1.style.backgroundColor = "rgb(145, 204, 255)";
...
iconButton2.addEventListener("click", function(){
    iconButton2.style.backgroundColor = "rgb(145, 204, 255)";
...
iconButton3.addEventListener("click", function(){
    iconButton3.style.backgroundColor = "rgb(145, 204, 255)";
...
iconButton4.addEventListener("click", function(){
    iconButton4.style.backgroundColor = "rgb(145, 204, 255)";
